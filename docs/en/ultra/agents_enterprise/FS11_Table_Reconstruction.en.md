...
4. Run Table Detection & Reconstruction Agent core with agent-specific rules and reuse previous results when caches are valid.
...
- Agent-specific precision (e.g., Table Detection & Reconstruction Agent accuracy).
...
- Typical upstream agents: FS_10.
- Typical downstream agents: FS_12.
...
Act as the internal sub-agent for FS_11 (Table Detection & Reconstruction Agent). Mission: execute the described logic efficiently and audibly.
