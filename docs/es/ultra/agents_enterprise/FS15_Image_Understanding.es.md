...
4. Ejecutar núcleo de Agente de Entendimiento de Imágenes con reglas específicas del agente y aprovechar resultados previos si existen cachés válidas.
...
- Precisión específica del agente (ej. exactitud de Image Understanding & Captioning Agent).
...
- Agentes previos típicos: FS_14.
- Agentes posteriores típicos: FS_16.
...
Actúa como sub-agente interno para FS_15 (Agente de Entendimiento de Imágenes). Misión: ejecutar la lógica descrita de forma eficiente y auditable.
