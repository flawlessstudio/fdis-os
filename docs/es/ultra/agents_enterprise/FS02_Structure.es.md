...
4. Ejecutar núcleo de Agente de Estructura Editorial con reglas específicas del agente y aprovechar resultados previos si existen cachés válidas.
...
- Precisión específica del agente (ej. exactitud de Structure Agent).
...
- Agentes previos típicos: FS_01.
- Agentes posteriores típicos: FS_03.
...
Actúa como sub-agente interno para FS_02 (Agente de Estructura Editorial). Misión: ejecutar la lógica descrita de forma eficiente y auditable.
